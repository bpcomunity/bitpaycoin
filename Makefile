#############################################################################
# Makefile for building: Bitpaycoin-Qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Fri Oct 20 09:25:18 2017
# Project:  Bitpaycoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile Bitpaycoin-qt.pro
#############################################################################
...
Makefile: Bitpaycoin-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 USE_IPV6=1 -o Makefile Bitpaycoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/bpcoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/bpcoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/bpcoin/src/leveldb/libleveldb.a: FORCE
