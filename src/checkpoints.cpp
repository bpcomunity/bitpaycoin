...
namespace Checkpoints
{
    ...
    // BP: synchronized checkpoint (centrally broadcasted)
    ...
    // BP: get last synchronized checkpoint
    ...
    // BP: only descendant of current sync-checkpoint is allowed
    ...
    // BP: reset synchronized checkpoint to last hardened checkpoint
...
// BP: verify signature of sync-checkpoint message
...
// BP: process synchronized checkpoint
