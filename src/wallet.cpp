...
// BP: total coins staked (non-spendable until maturity)
...
// BP: check 'spent' consistency between wallet and txindex
// BP: fix wallet spent state according to txindex
...
// BP: disable transaction (only for coinstake)
